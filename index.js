...
async function screenShot() {
    ...
    await sharp(path1 + "gagux123URL.png")
    .extract({ left: 695, top: 446, width: 200, height: 195 })
    ...
    .extract({ left: 350, top: 446, width: 130, height: 195 })
    ...
    await sharp(path1 + "ChilwellURL.png")
    .extract({ left: 710, top: 446, width: 200, height: 195 })
    ...
    await sharp(path1 + "Nalain420URL.png")
    .extract({ left: 707, top: 446, width: 200, height: 195 })
    ...
    */
    ...
    await sharp(path1 + "paid2URL.png")
    .extract({ left: 524, top: 446, width: 200, height: 195 })
    ...
    */
    ...
    await sharp(path1 + "KhaledURL.png")
    .extract({ left: 698, top: 446, width: 200, height: 195 })
